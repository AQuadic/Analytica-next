                        ...
                        <div className="part1">
                            ...
                            <form action="">
                                        ...
                                        <Group mt="xs">
                                            {
                                                payment_methods.map((payment) => {
                                                    ...
                                                    return (
                                                        <Radio key={payment.id} value={(payment.id).toString()}
                                ...
                                <div className="part apply">
                                    ...
                                    />
                                    <input type="submit" className="btn_page2" onClick={(e) => {
                                        e.preventDefault();
                                        handelCoupons()
                                    }} value={t('apply')}/>
                                ...
                                {ErrorMessage &&
                                    <p style={{color: "red", fontSize: "12px", marginTop: "-30px"}}>{ErrorMessage}</p>}
                            </form>
                        </div>
                        <div className="part2">
                            <h3>{t('summary')}</h3>
